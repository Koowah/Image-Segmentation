        ...
        for i in range(1, X_est.shape[0] - 1):
            for j in range(1, X_est.shape[1] - 1):
                ...
                for v in table_voisins:
                    ...
                    N_post[..., 0][i, j] = distribution_locale_apost[0]
                    N_post[..., 1][i, j] = distribution_locale_apost[1]
        Ppost = N_post
...
def main():
    ...
    m1, sig1, m2, sig2 = .3, .32, 0, .12 # gaussian noise parameters
    ...
    nb_iter_EM, nb_iter_Gibbs_EM, nb_simu_EM = 100, 20, 5
    m1_EM, sig1_EM, m2_EM, sig2_EM, dic_EM = EM_Gauss(Y, classes, nb_iter_EM, nb_iter_Gibbs_EM, nb_simu_EM)
